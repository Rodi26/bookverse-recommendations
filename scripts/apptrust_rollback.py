...
def main() -> int:
    ...
    p.add_argument("--base-url", default=_env("APPTRUST_BASE_URL"), help="Base API URL (env: APPTRUST_BASE_URL)")
    p.add_argument("--token", default=_env("APPTRUST_ACCESS_TOKEN"), help="Access token (env: APPTRUST_ACCESS_TOKEN)")
    args = p.parse_args()
